...
def _find_all_candidates_batched(facts_with_embeddings: list[dict],
    ...
    def _search_one_fact(new_fact):
        ...
        similar = vector_store.search_facts(new_fact["embedding"], top_k=2,
        ...
        keyword_hits = db.keyword_search_facts(new_fact["fact_text"], top_k=2,
                                               exclude_ids=exclude_ids)
        keyword_cands = [
    ...
    # Parallel search across all facts
    ...
    # Collect all unique candidate fact IDs, batch-fetch from DB
